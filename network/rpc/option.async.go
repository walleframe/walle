...
func WithAsyncCallOptionTimeout(v time.Duration) AsyncCallOption {
	return func(cc *AsyncCallOptions) AsyncCallOption {
		previous := cc.Timeout
		cc.Timeout = v
		return WithAsyncCallOptionTimeout(previous)
	}
}
...
func WithAsyncCallOptionMetadata(v metadata.MD) AsyncCallOption {
	return func(cc *AsyncCallOptions) AsyncCallOption {
		...
		cc.Metadata = v
		return WithAsyncCallOptionMetadata(previous)
	}
}
...
func WithAsyncCallOptionResponseFilter(v AsyncResponseFilter) AsyncCallOption {
	return func(cc *AsyncCallOptions) AsyncCallOption {
		...
		cc.ResponseFilter = v
		return WithAsyncCallOptionResponseFilter(previous)
	}
}
func WithAsyncCallOptionWaitFilter(v func(await func())) AsyncCallOption {
	return func(cc *AsyncCallOptions) AsyncCallOption {
		...
		cc.WaitFilter = v
		return WithAsyncCallOptionWaitFilter(previous)
	}
}
