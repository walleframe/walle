...
// NewEntry create custom entry for discovery new entry
func WithDiscoveryOptionsNewEntry(v func() Entry) DiscoveryOption {
	return func(cc *DiscoveryOptions) DiscoveryOption {
		previous := cc.NewEntry
		cc.NewEntry = v
		return WithDiscoveryOptionsNewEntry(previous)
	}
}

// Codec use for decode entry.
func WithDiscoveryOptionsCodec(v EntryCodec) DiscoveryOption {
	return func(cc *DiscoveryOptions) DiscoveryOption {
		previous := cc.Codec
		cc.Codec = v
		return WithDiscoveryOptionsCodec(previous)
	}
}

// Store use for discover entries
func WithDiscoveryOptionsStore(v kvstore.Store) DiscoveryOption {
	return func(cc *DiscoveryOptions) DiscoveryOption {
		previous := cc.Store
		cc.Store = v
		return WithDiscoveryOptionsStore(previous)
	}
}

// frame log
func WithDiscoveryOptionsFrameLogger(v *zaplog.Logger) DiscoveryOption {
	return func(cc *DiscoveryOptions) DiscoveryOption {
		previous := cc.FrameLogger
		cc.FrameLogger = v
		return WithDiscoveryOptionsFrameLogger(previous)
	}
}
